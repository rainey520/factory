package com.ruoyi.project.iso.filesource.controller;
...
public class FileSourceInfoController extends BaseController {
    ...
    public AjaxResult addSave(@RequestParam("avatarfile") MultipartFile file,
                              ...
                              @RequestParam("saveId") Integer saveId) {
        try {
            return toAjax(fileSourceService.saveFileInfo(file,saveType,saveId));
