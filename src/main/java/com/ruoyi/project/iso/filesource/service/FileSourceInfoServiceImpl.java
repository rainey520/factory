package com.ruoyi.project.iso.filesource.service;
...
public class FileSourceInfoServiceImpl implements IFileSourceInfoService {
    ...
    public int saveFileInfo(MultipartFile multipartFile, int saveType,int saveId) throws IOException {
        ...
        String filePath = RuoYiConfig.getProfile() + "product" + user.getCompanyId();
        ...
        fileInfo.setFilePath(isoFileUrl + "product" + user.getCompanyId() + "/" + fileName);
